                    ...
                    Positioned(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:  currentIndex == 0?  Colors.white.withOpacity(.35):Colors.transparent,
                                spreadRadius: 1,
                                blurRadius: 12,   offset: Offset(
                                0.0,
                                6.0,
                              ),
                              ),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:  currentIndex == 1?  Colors.white.withOpacity(.35):Colors.transparent,
                                spreadRadius: 1,
                                blurRadius: 12,   offset: Offset(
                                0.0,
                                6.0,
                    ...
                    Positioned(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:  currentIndex == 2?  Colors.white.withOpacity(.35):Colors.transparent,
                                spreadRadius: 1,
                                blurRadius: 12,   offset: Offset(
                                0.0,
                                6.0,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          bottomRight: Radius.circular(10),
                            ...
                            boxShadow: [
                              BoxShadow(
                                color:  currentIndex == 3?  Colors.white.withOpacity(.35):Colors.transparent,
                                spreadRadius: 1,
                                blurRadius: 12,   offset: Offset(
                                0.0,
                                6.0,
