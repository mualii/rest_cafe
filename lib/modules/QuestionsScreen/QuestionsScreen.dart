        ...
        return Container(
          ...
          child: ListView.separated(
              ...
              itemBuilder: (context, index) => InkWell(
                    onTap: () {
                      QuestionsCubit.get(context).changeListItem(index);
                    },
                    child: Container(
                      height: 40.h,
                      width: 80.w,
                      decoration:
                          index == QuestionsCubit.get(context).currentIndex
                              ? BoxDecoration(
                                  borderRadius: BorderRadius.circular(10.sp),
                                  color: Color(0xff707070),
                                )
                              : BoxDecoration(
                                  color: Color(0xff8E8E93).withOpacity(0.2),
                                  borderRadius: BorderRadius.circular(10.sp),
                                ),
                      child: Center(
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 18.sp,
                              color: index ==
                                      QuestionsCubit.get(context).currentIndex
                                  ? Colors.white
                                  : Color(0xff8E8E93)),
                        ),
                      ),
